...
input.grid(row=0,column=0,padx=15, pady=15, columnspan=3)
...
button_product = Button(root, text="*", padx=50, pady=25, command=product)
button_div = Button(root, text="/", padx=50, pady=25, command=div)
button_clear = Button(root, text="AC", padx=150, pady=25, command=clear)
...
button_product.grid(row=5, column=0)
